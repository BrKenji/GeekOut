...
class UserDBHelper(var context: Context) : SQLiteOpenHelper(context, DB_NAME, null, 1) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        val CREATE_USERS_TABLE = "CREATE TABLE IF NOT EXISTS $TABLE_USERS ($COL_ID INTEGER PRIMARY KEY AUTOINCREMENT, $COL_USERNAME TEXT NOT NULL, $COL_PASSWORD TEXT NOT NULL);"
